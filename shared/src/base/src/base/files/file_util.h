...
BASE_EXPORT bool DeleteFileTo(const FilePath& path, bool recursive);
...
// not kept.
BASE_EXPORT bool CopyFileTo(const FilePath& from_path, const FilePath& to_path);
...
BASE_EXPORT bool CreateDir(const FilePath& full_path);
